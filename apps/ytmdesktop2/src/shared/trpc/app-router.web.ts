...
const trackRouter = router({
	...
	like: publicProcedure.input(z.boolean()).mutation((): any => null),
	dislike: publicProcedure.input(z.boolean()).mutation((): any => null),
...
const updateRouter = router({
	...
	check: publicProcedure.mutation((): any => undefined),
