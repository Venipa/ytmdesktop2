...
export const trackRouter = router({
	...
	like: publicProcedure.input(z.boolean()).mutation(({ input }) => trackService.postTrackLike(undefined, input)),
	dislike: publicProcedure.input(z.boolean()).mutation(({ input }) => trackService.postTrackDisLike(undefined, input)),
