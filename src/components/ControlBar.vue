<template>
  <div class="flex items-stretch justify-between border-b bg-black border-gray-600 select-none h-10 px-2">
    <div class="flex items-center flex-1 drag" :class="{ 'justify-items-end': isMac }">
      ...
      <div class="w-px h-6 mx-2 bg-gray-600" v-if="isMac"></div>
    </div>
    <div class="flex items-center space-x-2">
      <a href="https://github.com/Venipa/ytmdesktop2" class="badge bg-primary rounded px-2" target="_blank">BETA</a>
