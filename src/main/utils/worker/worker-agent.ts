...
export class WorkerAgent<TInput, TOutput> {
	...
	private registerEventListener(workerEventSubscriptionMethod: WorkerEventSubscriptionMethod, agentEvent: string, callback: GenericCallback): this {
		switch (agentEvent) {
			case "result":
	...
	private registerResultListener(workerSubscriptionMethod: WorkerEventSubscriptionMethod, callback: GenericCallback): void {
