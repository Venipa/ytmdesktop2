<template>
  <div class="flex flex-row items-center space-x-2">
    <div @click="() => action('nav.same-origin')"
...
export default defineComponent({
  components: { RPCIcon, HomeIcon, DevIcon, RefreshIcon, MiniPlayerIcon },
  setup() {
